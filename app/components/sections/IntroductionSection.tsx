    ...
    <section className="py-32" ref={sectionRef}>
      <div className="container mx-auto px-6">
        <div className="mx-auto flex max-w-6xl flex-col items-center md:flex-row">
          ...
          >
            <motion.span
              className="mb-6 block text-sm font-light tracking-widest uppercase opacity-80"
            ...
            >
              ...
              perfect blend of modern comfort and traditional Kerala
              architecture.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0 -z-10 translate-x-4 translate-y-4"
